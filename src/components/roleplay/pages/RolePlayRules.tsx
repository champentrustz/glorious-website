    ...
    return (
        <div className={'w-full h-auto  overflow-auto flex flex-col justify-center items-center relative'}>
            ...
            <div className={'w-full h-[35vh] overflow-hidden relative flex justify-center items-center bg-black'}>
                ...
                <p className={`text-4xl text-white text-shadow-md z-10 ${notoSansThai.className}`}>กฏภายในเมือง</p>
            </div>

            <div className={'w-full h-full flex flex-col justify-center items-center px-2 py-10 overflow-hidden'}>

                <div className={'w-full tablet:w-full s-desktop:w-full m-desktop:w-4/5 l-desktop:w-3/5 h-full flex flex-col justify-center items-center bg-white shadow-md'}>



                    <div className={`w-full h-[80vh] p-4 gap-10 flex flex-col justify-center items-center `}>
                        <p className={` ${notoSansThai.className} text-2xl text-neutral-800 flex gap-6`}>
                            กฏการเล่นพื้นฐาน
