    ...
    return (
        <div className={'w-full h-auto  overflow-auto flex flex-col gap-10 justify-center items-center relative'}>
            ...
            <div
                ...
                <p className={`text-xl tablet:text-xl s-desktop:text-xl m-desktop:text-4xl l-desktop:text-4xl text-white text-shadow-md z-10 ${notoSansThai.className}`}>ตารางกิจกรรมภายในเมือง</p>
            </div>

            <div
                className={'w-full h-full flex flex-col justify-center items-center px-2 gap-10 pb-10 overflow-hidden'}>
