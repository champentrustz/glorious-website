...
const RolePlaySystems = () => {
    ...
    return (
        <div className={'w-full h-auto  overflow-auto flex flex-col justify-center items-center relative'}>
            ...
            <div className={`w-full tablet:w-full s-desktop:w-full m-desktop:w-4/6 l-desktop:w-3/5  h-auto tablet:h-auto s-desktop:h-[80vh] m-desktop:h-[80vh] l-desktop:h-[80vh] 
