        ...
        <>
            {
                systemShowCaseData.map((system, index) =>
                    ...
                    <div
                        ...
                        className={`w-16 h-12 tablet:h-20 s-desktop:h-20 m-desktop:h-32 l-desktop:h-32 tablet:w-24 s-desktop:w-28 m-desktop:w-36 l-desktop:w-36 absolute m-auto z-10 flex flex-col justify-between items-center`}
                        style={{
                    ...
                    >
                        ...
                        <div
                            className='w-full h-6 shrink-0 tablet:h-6 s-desktop:h-8 m-desktop:h-8 l-desktop:h-8 flex justify-center items-center text-white text-xs tablet:text-xs s-desktop:text-xs m-desktop:text-sm l-desktop:text-sm text-shadow-md whitespace-nowrap'>
                            <div className='h-full w-5 shrink-0 flex justify-center items-center relative'>
                                <div
                                    className='h-2 tablet:h-2 s-desktop:h-2 m-desktop:h-3 l-desktop:h-3 aspect-square absolute inset-0 m-auto z-0 animate-ping rounded-full bg-green-500'></div>
                                <div
                                    className='h-1 tablet:h-1 s-desktop:h-1 m-desktop:h-2 l-desktop:h-2 aspect-square rounded-full bg-green-500 z-10'></div>
                            </div>
